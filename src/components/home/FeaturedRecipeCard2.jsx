...
export default function FeaturedRecipeCard2({ recipe }) {
  const navigate = useNavigate();

  return (
    <div
      className="group absolute top-[8%] md:top-[15%] -right-[5%] md:right-[5%] lg:right-[12%] w-36 md:w-44 lg:w-52 bg-white/80 backdrop-blur-xl border border-white p-2.5 md:p-3 rounded-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] animate-drift-2 z-0 opacity-50 md:opacity-70 xl:opacity-100 hover:z-20 transition-all hover:scale-110 hover:shadow-[0_40px_70px_-15px_rgba(249,115,22,0.15)] hover:!animate-none duration-500 cursor-pointer"
